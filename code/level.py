                ...
                for col_index,col in enumerate(row):
                    if col != '-1':
                        ...
                        if style == 'grass':
                            ...
                            Tile((x,y),[self.obstacles_sprites,self.visible_sprites,self.attackable_sprites],'grass',random_grass_image)
                            
                        if style == 'object':
                            surf = graphics['objects'][int(col)]
                            Tile((x,y),[self.obstacles_sprites,self.visible_sprites],'object',surf)
        #         if col == 'x':
